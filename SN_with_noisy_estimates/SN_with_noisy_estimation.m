...
% alpha=0.5;%natual
r=1.3; %r=1.3,N3;r=0.5,N5;r=0.5,N7;
K=3;%class
...
for t=1:100
    ...
    sigma=sum((q1_ik'+q1n_ik').*(repmat(Y,K,1)-repmat(Mu,1,m)-x_ij).^2+ou_ij)./(sum((q1_ik'+q1n_ik'),2)+eps);
